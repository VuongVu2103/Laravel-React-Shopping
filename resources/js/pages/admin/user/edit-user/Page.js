...
class Page extends React.Component {
  ...
  componentDidMount () {
    let url = window.Laravel.baseUrl + '/api/admin/users/' + this.props.match.params.id + '/edit'
    axios.get(url)
      .then(response => {
  ...
  handleSubmit (e) {
    e.preventDefault()
    let url = window.Laravel.baseUrl + '/api/admin/users/' + this.props.match.params.id
    const data = {
